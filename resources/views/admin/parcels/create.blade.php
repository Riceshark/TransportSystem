...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.parcels.store']]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::hidden('origin_latitude', 0 , ['id' => 'origin-latitude']) !!}
                    {!! Form::hidden('origin_longitude', 0 , ['id' => 'origin-longitude']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('insurance', 1, old('insurance', false), []) !!}
                    <p class="help-block"></p>
