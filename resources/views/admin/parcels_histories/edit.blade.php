...
@section('content')
    ...
    {!! Form::model($parcels_history, ['method' => 'PUT', 'route' => ['admin.parcels_histories.update', $parcels_history->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::hidden('location_latitude', $parcels_history->location_latitude , ['id' => 'location-latitude']) !!}
                    {!! Form::hidden('location_longitude', $parcels_history->location_longitude , ['id' => 'location-longitude']) !!}
                    <p class="help-block"></p>
